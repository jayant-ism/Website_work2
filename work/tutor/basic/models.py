...
class filter_details(models.Model) : 
    language = models.CharField(max_length=45, blank=True ,default='English') 
    hourly_rate = models.FloatField(default='5' , blank=True )
    talent = models.CharField(max_length=45 , default='Intermediate' , blank=True )
    location = models.CharField(max_length=60 , default='USA')
    user = models.ForeignKey('User', models.DO_NOTHING, blank=False, null=True)
